...
def create_translator_hub_from_directory(path: str = 'resources/locales',
                                         root_locale: str = 'ru') -> TranslatorHub:
    locales = [
        os.path.basename(language_path)  # resources/locales/ua-UA -> ua-UA
